...
// find exercise
/* Lightning Exercise 2: Refactor your codeso that if the search text is found in the first name,
 or last name, of any purchasing agent, show that agent. */
outEl = document.querySelector("#agentSearch")
document
    .querySelector("#findAgent")
